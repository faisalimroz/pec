...
import { searchLetterAttachmentRS } from '@/api/roadTrafficAPIs'
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/roadSafety-patrol-letterattachment/update/by/${updatedProduct._id}`,
                formData,
                {
                    headers: {
    ...
    const saveProduct = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/roadSafety-patrol-letterattachment/create`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
    ...
    const deleteProduct = async () => {
        ...
        try {
            ...
            const res = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/roadSafety-patrol-letterattachment/delete-multiple/${product._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const deleteSelectedProducts = async () => {
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/roadSafety-patrol-letterattachment/delete-multiple`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    return (
        <div className=''>
            ...
            <BulkUploadDialog
                ...
                apiEndpoint="/api/v1/road-traffic/roadSafety-patrol-letterattachment/bulk-upload"
                onSuccess={refetch}
