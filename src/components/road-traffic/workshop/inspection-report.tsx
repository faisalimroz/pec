...
import { searchInspectionWM } from '@/api/roadTrafficAPIs'
...
export default function MonthlyReport() {
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/workshop-inspectionreport/update/by/${updatedProduct._id}`,
                formData,
                {
                    headers: {
    ...
    const saveProduct = async () => {
        ...
        const requiredFields = [
            ...
            { value: department, name: 'Patient Type' }, // Validating the 'department' variable
        ...
        try {
            ...
            formData.append('patientType', department) // Mapping department to patientType
            ...
            const res = await axios.post(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/workshop-inspectionreport/create`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
    ...
    const deleteProduct = async () => {
        ...
        try {
            ...
            const res = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/workshop-inspectionreport/delete/by/${product._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const deleteSelectedProducts = async () => {
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/workshop-inspectionreport/delete-multiple`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const viewProductDialogFooter = (
      ...
      /> */}
       ...
       const handleSearch = () => {
              ...
              console.log(payload)
              searchInspectionWM(payload).then((result) => {
    ...
    return (
        <div className=''>
            ...
            <BulkUploadDialog
                ...
                apiEndpoint="/api/v1/road-traffic/workshop-inspectionreport/bulk-upload"
                onSuccess={refetch}
