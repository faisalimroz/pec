...
import { searchRTMCompletionForm } from '@/api/adminAPIs'
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/completion-forms/update/by/${updatedProduct._id}`,
                formData,
                {
                    headers: {
 ...
 const saveProduct = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/completion-forms/create`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
    ...
    const deleteProduct = async () => {
        ...
        try {
            ...
            const res = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/miscellaneous/delete/by/${product._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const deleteSelectedProducts = async () => {
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/miscellaneous/delete-multiple`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    return (
        <div className=''>
            ...
            <BulkUploadDialog
                ...
                apiEndpoint="/api/v1/road-traffic/completion-forms/bulk-upload"
                onSuccess={refetch}
