...
import { searchInventoryReport } from '@/api/roadTrafficAPIs'
...
export default function InventoryReportTable() {
  ...
  const codes = [
    ...
    { name: 'Mechanical/Electrical', code: 'mechanical' },
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      formData.append('team', updatedProduct.team)
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/mechanical/inventory/update/${updatedProduct._id}`,
        formData,
        {
          headers: {
            'Content-Team': 'multipart/form-data',
  ...
  const uploadFile = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/mechanical/inventory/bulk-upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const saveProduct = async () => {
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/mechanical/inventory/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/mechanical/inventory/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const deleteSelectedProducts = async () => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/road-traffic/mechanical/inventory/delete/multiple/data`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    const initialPayload = {
      ...
      // @ts-ignore
      team: selectedCode?.name || '',
      searchQuery: searchKey,
    }

    searchInventoryReport(initialPayload).then((result) => {
      setProducts(result?.InventoryReports)
      setLoading(false)
    })
  }
          ...
          <>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <p className='break-all'>{selectedProduct.team}</p>
              </div>
