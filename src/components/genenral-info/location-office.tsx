...
export default function OfficeLocation() {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/office_location/all`,
        {
          headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/office_location/update/${selectedProject._id}`,
        formData,
        {
          headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/office_location/delete/${selectedProject._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/office_location/create/layout`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
