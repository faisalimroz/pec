...
//   const medicineRecordPermission = clinicPermission?.children.find(
//     (c) => c.name === 'medicine-record'
//   )

//   const hasEditAccess = medicineRecordPermission?.edit_authority || false

//   // For backward compatibility, also check roles
...
//         `${import.meta.env.VITE_BASE_URL}/api/v1/admin/clinic/medicine-record/update/${updatedProduct._id}`,
//         formData,
//         {
//           headers: {
...
//         `${import.meta.env.VITE_BASE_URL}/api/v1/admin/clinic/medicine-record/upload`,
//         formData,
//         {
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem('token')}`,
...
//         `${import.meta.env.VITE_BASE_URL}/api/v1/admin/clinic/medicine-record/delete/${product._id}`,
//         {
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem('token')}`,
//           },
...
//         `${import.meta.env.VITE_BASE_URL}/api/v1/admin/clinic/medicine-record/delete/multiple/data`,
//         {
//           headers: {
//             Authorization: `Bearer ${localStorage.getItem('token')}`,
//           },
...
//     searchMedicineRecord(initialPayload).then((result) => {
//       setProducts(result?.Medicines)
//       setLoading(false)
//     })
//   }
