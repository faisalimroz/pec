...
export default function ArialImage() {
  ...
  const fetchProjects = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/aerial_img/all`
      )
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/aerial_img/update/${selectedProject._id}`,
        formData,
        {
          headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/aerial_img/delete/${selectedProject._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/general/aerial_img/create/layout`,
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
            ...
            <div className='grid grid-cols-2 gap-4'>
              {projects.map((project) => (
                ...
                >
                  ...
                  />
                  <div className='mt-2 mx-2 text-start'>
