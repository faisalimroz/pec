...
const TollButtonIcons: React.FC<TollButtonIconsProps> = ({
    ...
    return (
        <div className="flex space-x-2">
            <button
                className="flex items-center gap-2 bg-[#0B1F8F] text-white border border-[#E5E7EB] px-4 py-3 rounded-md font-bold"
                onClick={openNew}
            >
                <VireGrahpIcon />
                View Graph
            ...
            <button
                className="flex items-center gap-2   bg-white   text-[#0B1F8F] border border-[#E5E7EB]  font-bold px-4 py-3 rounded-md"
                onClick={exportPDF}
            >
                <Export />
            ...
            <button
                className={`flex items-center gap-2 py-3 px-4 text-[#0B1F8F]   bg-white border border-[#E5E7EB] font-semibold rounded-t-md         
                    }`}
                onClick={exportCSV}
            ...
            <button
                className="flex items-center gap-2  border border-[#E5E7EB] bg-white text-[#0B1F8F] px-4 py-3 rounded-md font-bold"
                onClick={handlePrint}
            >
                <PrintIcon />
                Print
