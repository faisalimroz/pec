  ...
  >
    <div className='p-2'>
      <div className='mb-4'>
        ...
        <div>
          <p className='text-xl 2xl:text-3xl  font-bold tabular-nums p-2'>
...
export function TotalTollTraffic() {
  ...
  return (
    <div className='w-full rounded-xl overflow-hidden border shadow-md relative'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-3 p-4 relative'>
        
        
        {isUpdating && (
          <div className="absolute inset-0 bg-white/60 z-10 flex items-center justify-center backdrop-blur-[1px] rounded-b-xl">
             <div className="bg-white px-3 py-1 rounded-full shadow-lg border border-gray-200">
                <span className="text-sm font-semibold text-[#0a1747] flex items-center gap-2">
...
const TakaIcon = () => {
  return (
    <svg width='20' height='20' viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g clipPath='url(#clip0_22_2105)'>
        <path d='M5.14697 1.40625V7.03125C8.23679 3.58073 12.7225 1.40625 17.7188 1.40625C27.0386 1.40625 34.5938 8.96147 34.5938 18.2812C34.5938 20.2536 34.2555 22.1469 33.6337 23.9062' stroke='white' strokeWidth='2' strokeMiterlimit='10' strokeLinecap='round' strokeLinejoin='round' />
        <g clipPath='url(#clip1_22_2105)'>
          <path d='M11.4063 9.26172C10.7188 9.17579 10.0938 9.66016 10.0079 10.3438C9.92192 11.0273 10.4102 11.6563 11.0938 11.7422L11.4024 11.7813C12.0274 11.8594 12.4961 12.3906 12.4961 13.0234L12.5 14.25H11.25C10.5586 14.25 10 14.8086 10 15.5C10 16.1914 10.5586 16.75 11.25 16.75H12.5V23C12.5 25.0703 14.1797 26.75 16.25 26.75H17.5C21.6407 26.75 25 23.3906 25 19.25V18C25 15.9297 23.3204 14.25 21.25 14.25H20.625C19.9336 14.25 19.375 14.8086 19.375 15.5C19.375 16.1914 19.9336 16.75 20.625 16.75H21.25C21.9415 16.75 22.5 17.3086 22.5 18V19.25C22.5 22.0117 20.2618 24.25 17.5 24.25H16.25C15.5586 24.25 15 23.6914 15 23V16.75H16.25C16.9415 16.75 17.5 16.1914 17.5 15.5C17.5 14.8086 16.9415 14.25 16.25 14.25H15V13.0195C15 11.1289 13.5899 9.53125 11.7149 9.29688L11.4063 9.25782V9.26172Z' fill='white' />
        </g>
        <path d='M30.9375 34.5938V28.9688L30.8939 28.93C27.803 32.4049 23.2977 34.5938 18.2812 34.5938C8.96147 34.5938 1.40625 27.0385 1.40625 17.7188C1.40625 15.7464 1.74459 13.8531 2.36644 12.0938' stroke='white' strokeWidth='2' strokeMiterlimit='10' strokeLinecap='round' strokeLinejoin='round' />
      </g>
      <defs>
        <clipPath id='clip0_22_2105'><rect width='36' height='36' fill='white' /></clipPath>
        <clipPath id='clip1_22_2105'><rect width='15' height='20' fill='white' transform='translate(10 8)' /></clipPath>
      </defs>
    </svg>
  )
}