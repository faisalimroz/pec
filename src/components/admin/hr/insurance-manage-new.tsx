...
import { searchInsuranceManagementNew } from '@/api/adminAPIs'
...
import EmPersonalDetail from './insurance-manage-detail-new'
...
export default function EmPersonalProfileTable() {
  ...
  const handleSearch = () => {
    ...
    searchInsuranceManagementNew(initialPayload).then((result) => {
      ...
      <div className='ml-4'>
        ...
        >
          <>
            ...
            <div className='gap-3 mt-5'>
              <label className='block mb-1 font-semibold'>
                Upload Termination Letter Files
              </label>
