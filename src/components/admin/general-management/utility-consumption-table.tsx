...
export default function RecruitmentTable() {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      formData.append('amount', updatedProduct.amount)
      formData.append('quantity', updatedProduct.quantity)
      formData.append('meterNo', updatedProduct.meterNo)
      formData.append('unityType', updatedProduct.unityType)
      formData.append('purpose', updatedProduct.unityType)
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/admin/general/unity/update/${updatedProduct._id}`,
        formData,
        {
          headers: {
  ...
  const saveProduct = async () => {
    ...
    try {
      ...
      formData.append('unityType', unityType)
      formData.append('location', location)
      formData.append('amount', amount)
      formData.append('quantity', quantity)
      formData.append('meterNo', meterNo)
      formData.append('purpose', unityType)
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/admin/general/unity/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/admin/general/unity/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    const initialPayload = {
      ...
      // @ts-ignore
      unityType: selectedCode?.code || '',
    }

    searchUtilityConsumption(initialPayload).then((result) => {
      setProducts(result?.UnityConsumptions)
      setLoading(false)
    })
  }
      ...
      >
        {updatedProduct && (
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='field'>
              <label htmlFor='unityType' className='font-bold'>
                Utility Type
              </label>
              <Dropdown
                id='unityType'
                value={updatedProduct.unityType}
                options={['Electricity', 'Gasoline', 'LPG', 'Fuel']}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    unityType: e.target.value,
                  })
                }
                placeholder='Select Utility Type'
                optionLabel='unityType'
              />
            </div>
            ...
            <div className='field'>
              <label htmlFor='meterNo' className='font-bold'>
                MeterNo
              </label>
              <InputText
                id='meterNo'
                value={updatedProduct.meterNo}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
      ...
      >
        {selectedProduct && (
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div>
              <h3 className='font-bold'>Utility Type</h3>
              <p className='break-all'>{selectedProduct.unityType}</p>
            </div>
            <div>
            ...
            <div>
              <h3 className='font-bold'>Amount (BDT)</h3>
            ...
            <div>
              <h3 className='font-bold'>Meter No.</h3>
              <p className='break-all'>{selectedProduct.meterNo}</p>
            </div>
            <div>
          ...
          <div className='grid grid-cols-2 items-center gap-6'>
            ...
            <div className='field'>
              ...
              <Dropdown
                ...
                value={unityType}
                options={['Electricity', 'Gasoline', 'LPG', 'Fuel']}
                onChange={(e) => setUnityType(e.value)}
                placeholder='Select Utility Type'
                optionLabel='unityType'
              />
            </div>
