  ...
  const fetchLayout = async () => {
    ...
    try {
      const response = await axios.get<ApiResponse>(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/staff/overview/organization-chart`,
        {
          headers: {
    ...
    <div className='w-full bg-white'>
            ...
            <div className=' w-full'>
              <div className='relative w-full'>
                ...
                <img
                  src={layout.image}
                  alt='Project Layout'
                  className={`w-1/2 object-contain rounded-lg shadow-lg mx-auto transition-opacity duration-300 ${
      ...
      >
        <DialogContent className='sm:max-w-[425px]'>
          <DialogHeader>
            <DialogTitle>Upload Overview</DialogTitle>
          </DialogHeader>
