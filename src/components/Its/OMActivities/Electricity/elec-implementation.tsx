...
import { OmElecImplementation, useOnmElecImplement } from '@/api/itsAPIs'
...
export default function OMActivityElcImplementation() {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/om-activates/electricity/implementation/${updatedProduct._id}`,
        formData,
        {
          headers: {
  ...
  const place = [
    { name: 'Dhaleshwari Toll Plaza', code: 'Dhaleshwari Toll Plaza' },
    { name: 'Bhanga Toll Plaza', code: 'Bhanga Toll Plaza' },
    { name: 'Abdullahpur Toll Plaza', code: 'Abdullahpur Toll Plaza' },
    { name: 'Sreenagar Toll Plaza', code: 'Sreenagar Toll Plaza' },
    { name: 'Maligram Toll Plaza', code: 'Maligram Toll Plaza' },
    { name: 'Pulia Toll Plaza', code: 'Pulia Toll Plaza' },
  ]
  ...
  const saveProduct = async () => {
    try {
      ...
      formData.append('site', formTypes)
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/om-activates/electricity/implementation/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/om-activates/electricity/implementation/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    OmElecImplementation(initialPayload).then((result) => {
  ...
  const deleteSelectedProducts = async () => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/om-activates/electricity/implementation/delete/multiple/data`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const { data, isLoading, error, refetch } = useOnmElecImplement(payload)
