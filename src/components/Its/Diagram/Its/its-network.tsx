...
import { DiagramItsNetwork, useDiagramNetwork } from '@/api/itsAPIs'
...
export default function NetworkTable() {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/diagram/its/network/${updatedProduct._id}`,
        formData,
        {
          headers: {
  ...
  const saveProduct = async () => {
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/diagram/its/network/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/diagram/its/network/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    DiagramItsNetwork(initialPayload).then((result) => {
  ...
  const { data, isLoading, error, refetch } = useDiagramNetwork(payload)
  ...
  const deleteSelectedProducts = async () => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/diagram/its/network/delete/multiple/data`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='field'>
              ...
              <Dropdown
                ...
                options={['Internet', 'Radio', 'CCTV', 'LAN', 'PABX']}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
