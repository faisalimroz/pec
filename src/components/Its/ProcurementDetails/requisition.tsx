...
export default function ProcurementQuotation() {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      formData.append('submittedBy', updatedProduct.submittedBy)
      formData.append('submittedTo', updatedProduct.submittedTo)
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/procurement/requisition/${updatedProduct._id}`,
        formData,
        {
          headers: {
  ...
  const saveProduct = async () => {
    try {
      ...
      formData.append('submittedBy', dataList.submittedBy)
      formData.append('submittedTo', dataList.submittedTo)
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/procurement/requisition/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/procurement/requisition/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const deleteSelectedProducts = async () => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/procurement/requisition/delete/multiple/data`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    procurementRequisition(initialPayload).then((result) => {
  ...
  const { data, isLoading, error, refetch } = useProcurementRequisition(payload)
      ...
      >
        <>
          <div className='grid grid-cols-2 items-center gap-6'>
            ...
            <div className='field'>
              <label htmlFor='submittedBy' className='font-bold'>
                Submitted By
              </label>
              <InputText
                id='submittedBy'
                value={dataList.submittedBy}
                onChange={handleInputChange}
              />
            </div>
            <div className='field'>
              <label htmlFor='submittedTo' className='font-bold'>
                Submitted To
              </label>
              <InputText
                id='submittedTo'
                value={dataList.submittedTo}
                onChange={handleInputChange}
              />
            </div>
        ...
        {selectedProduct && (
          <>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              <div>
                <h3 className='font-bold'>Submitted To</h3>
                <p className='break-all'>{selectedProduct.submittedTo}</p>
              </div>
              <div>
                <h3 className='font-bold'>Submitted By</h3>
                <p className='break-all'>{selectedProduct.submittedBy}</p>
              </div>
              <div>
        ...
        {updatedProduct && (
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='field'>
              ...
              <InputText
                id='submittedTo'
                value={updatedProduct.submittedTo}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
            ...
            <div className='field'>
              ...
              <InputText
                id='submittedBy'
                value={updatedProduct.submittedBy}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
