...
import { useWarrantyPL, warrantyProductReport } from '@/api/itsAPIs'
...
interface Product {
  ...
  warrantyTo: string
  remarks: string
  attachments: Array<{ url: string; _id: string }>
...
export default function WarrantyProduct() {
  ...
  const checkPermission = checkRole?.children.find((c) => c.name === 'warranty')
  ...
  const [warrantyFrom, setWarrantyFrom] = useState<string>('')
  const [warrantyTo, setWarrantyTo] = useState<string>('')
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      formData.append('productModel', updatedProduct.productModel)
      formData.append('productLocation', updatedProduct.productLocation)
      formData.append('warrantyFrom', updatedProduct.warrantyFrom)
      formData.append('warrantyTo', updatedProduct.warrantyTo)
      ...
      const res = await axios.put(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/warranty/product/${updatedProduct._id}`,
        formData,
        {
          headers: {
  ...
  const saveProduct = async () => {
    try {
      ...
      formData.append('productModel', dataList.productModel)
      formData.append('productLocation', dataList.productLocation)
      formData.append('remarks', remarks)
      formData.append('warrantyFrom', formatDate(warrantyFrom))
      formData.append('warrantyTo', formatDate(warrantyTo))
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/warranty/product/upload`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
  ...
  const deleteProduct = async () => {
    ...
    try {
      ...
      const res = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/warranty/product/delete/${product._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const deleteSelectedProducts = async () => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_BASE_URL}/api/v1/its/warranty/product/delete/multiple/data`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
  ...
  const handleSearch = () => {
    ...
    warrantyProductReport(initialPayload).then((result) => {
  ...
  const { data, isLoading, error, refetch } = useWarrantyPL(payload)
      ...
      >
        <>
          <div className='grid grid-cols-2 items-center gap-6'>
            ...
            <div className='field'>
              <label htmlFor='productModel' className='font-bold'>
                Product Model
              </label>
              <InputText
                id='productModel'
                value={dataList.productModel}
                onChange={handleInputChange}
              />
            </div>

            <div className='field'>
              <label htmlFor='productLocation' className='font-bold'>
                Service Provider
              </label>
              <InputText
                id='productLocation'
                value={dataList.productLocation}
                onChange={handleInputChange}
              />
            </div>
            ...
            <div>
              <label htmlFor='warrantyFrom' className='font-bold'>
                Warranty From
              </label>
              <div className='border rounded-md'>
                <Calendar
                  id='warrantyFrom'
                  // @ts-ignore
                  onChange={(e) => setWarrantyFrom(e.value)}
                  dateFormat='dd/mm/yy'
                  inputClassName='border-0 focus:ring-0 cursor-pointer'
                  className='focus:ring-0'
                  placeholder='Select Date'
            ...
            <div>
              <label htmlFor='warrantyTo' className='font-bold'>
                Warranty To
              </label>
              <div className='border rounded-md'>
                <Calendar
                  id='warrantyTo'
                  // @ts-ignore
                  onChange={(e) => setWarrantyTo(e.value)}
                  dateFormat='dd/mm/yy'
                  inputClassName='border-0 focus:ring-0 cursor-pointer'
                  className='focus:ring-0'
                  placeholder='Select Date'
          ...
          <>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <p className='break-all'>{selectedProduct.productModel}</p>
              </div>
              <div>
                <h3 className='font-bold'>Product Location</h3>
                <p className='break-all'>{selectedProduct.productLocation}</p>
              </div>
              <div>
                <h3 className='font-bold'>Warranty Period</h3>
                <p className='break-all'>{selectedProduct.warrantyPeriod}</p>
              </div>
              <div>
                <h3 className='font-bold'>Warranty Duration</h3>
                <p className='break-all'>{selectedProduct.warrantyDuration}</p>
              </div>
              <div>
        ...
        {updatedProduct && (
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div className='field'>
              ...
              <InputText
                id='productModel'
                value={updatedProduct.productModel}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
            ...
            <div className='field'>
              ...
              <InputText
                id='productModel'
                value={updatedProduct.productLocation}
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    productModel: e.target.value,
            ...
            <div className='field'>
              ...
              <Calendar
                ...
                value={
                  new Date(
                    updatedProduct.warrantyFrom.split('-').reverse().join('-')
                  )
                }
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    warrantyFrom: e.value ? formatDate(e.value) : '',
                  })
                }
                dateFormat='dd/mm/yy'
              />
            ...
            <div className='field'>
              ...
              <Calendar
                ...
                value={
                  new Date(
                    updatedProduct.warrantyTo.split('-').reverse().join('-')
                  )
                }
                onChange={(e) =>
                  setUpdatedProduct({
                    ...updatedProduct,
                    warrantyTo: e.value ? formatDate(e.value) : '',
                  })
                }
                dateFormat='dd/mm/yy'
              />
