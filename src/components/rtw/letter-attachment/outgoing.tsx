...
import { searchRTWLetterAttachmentOutgoinging } from '@/api/rtwAPIs'
...
export default function MonthlyReport() {
    ...
    const adminManagerPermission = permissions.find((p) => p.name === 'rtw-manager');
    const adminPermission = adminManagerPermission?.children?.find((child) => child.name === 'rtw-letter-attachment');
    ...
    const handleUpdateProduct = async () => {
        ...
        try {
            ...
            const res = await axios.put(
                `${import.meta.env.VITE_BASE_URL}/api/v1/rtw/letter-attachment/outgoing/update/by/${updatedProduct._id}`,
                formData,
                {
                    headers: {
    ...
    const uploadFile = async () => {
        ...
        try {
            const response = await axios.post(
                `${import.meta.env.VITE_BASE_URL}/api/v1/rtw/letter-attachment/outgoing/bulk-upload`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
    ...
    const saveProduct = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                `${import.meta.env.VITE_BASE_URL}/api/v1/rtw/letter-attachment/outgoing/create`,
                formData,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
    ...
    const deleteProduct = async () => {
        ...
        try {
            ...
            const res = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/rtw/letter-attachment/outgoing/delete/by/${product._id}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const deleteSelectedProducts = async () => {
        try {
            ...
            const response = await axios.delete(
                `${import.meta.env.VITE_BASE_URL}/api/v1/rtw/letter-attachment/outgoing/delete-multiple`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem('token')}`,
                    },
    ...
    const handleSearch = () => {
        ...
        searchRTWLetterAttachmentOutgoinging(payload).then((result) => {
    ...
    const refetch = () => {
        ...
        searchRTWLetterAttachmentOutgoinging(initialPayload).then((result) => {
            const rows = Array.isArray(result?.data) ? result.data : [];
            setProducts(rows)
            setLoading(false)
        })
