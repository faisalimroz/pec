...
// import { financeTopNav, getFilteredNavLinks } from '@/data/topNavLinks'
// import DemoTable from '@/components/finance/toll-money-for-cash-table'
// import { useAuth } from '@/provider/authProvider'

// export default function TollMoneyForCash() {
//   const [isCollapsed, setIsCollapsed] = useIsCollapsed()

//   const { roles } = useAuth()
//   const userRoles = roles.map((role) => role.title)

//   const selectedNav = financeTopNav
...
//                 <h1 className='text-2xl font-bold tracking-tight md:text-3xl pl-4 text-main'>
//                   Toll Money Management For Cash
//                 </h1>
