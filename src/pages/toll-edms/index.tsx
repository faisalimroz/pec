...
import DemoTable from '@/components/toll/toll-collect-traffic-table'
...
import { tollLinks } from '@/data/sidelinks-edms'
export default function TollCollectTraffic() {
