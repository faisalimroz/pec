...
import { itsLinks } from '@/data/sidelinks'
import { getFilteredNavLinks, itsTopNav } from '@/data/topNavLinks'
import DemoTable from '@/components/Its/InventoryManage/Electricity/ElectricityMain'
            ...
            <LayoutBody className='space-y-4'>
              <div className='space-y-2'>
                <h1 className='text-2xl font-bold tracking-tight md:text-3xl pl-4'>
                  Inventory Management-Electricity
                </h1>
