...
export const tollTopNav = [
  ...
  },
  {
    ...
    isActive: false,
    logo: edmsIcon,
    roles: ['superadmin', 'admin', 'mb-pmis-manager'],
    uName: 'mb-pmis',
  },
  {
    title: 'RTW',
    ...
    isActive: false,
    logo: edmsIcon,
    roles: ['superadmin', 'admin', 'rtw-manager'],
    uName: 'rtw',
  },
...
//     isActive: true,
//     logo: edmsIcon,
//     roles: ['superadmin', 'toll-manager','its-manager'],
//     uName: 'toll',
//   },
//   {
//     title: 'ITS',
...
//     isActive: false,
//     logo: edmsIcon,
//     roles: ['edms', 'superadmin','its-manager'],
//     uName: 'edms',
//   },
// ]
...
export const itsTopNav = [
  ...
  },
  {
    ...
    isActive: false,
    logo: edmsIcon,
    roles: ['superadmin', 'admin', 'finance-manager'], // Reverted to match rtwTopNav
    uName: 'rtw',
  },
  {
    title: 'Toll Operation',
    ...
    isActive: false,
    logo: edmsIcon,
    roles: ['superadmin', 'toll-manager'], // Removed 'its-manager' to match rtwTopNav
    uName: 'toll',
  },
  {
    title: 'ITS',
...
export const pmisTopNav = [
  ...
  },
  {
    ...
    isActive: true,
    logo: edmsIcon,
    roles: ['superadmin', 'admin', 'finance-manager','mb-pmis-manager'],
    uName: 'mb-pmis',
  },
  {
    title: 'RTW',
